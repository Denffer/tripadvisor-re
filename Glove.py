...
def parse_args():
    ...
    parser.add_argument('corpus', metavar='corpus_path', type=partial(codecs.open, encoding='utf-8'))
    ...
    g_cooccur.add_argument('--min-count', type=int, default=None,
...
def train_glove(vocab, cooccurrences, iter_callback=None, vector_size=100, iterations=25, **kwargs):
    """
...
def main(arguments):
    ...
    # get file name
    filename = re.findall("[A-Za-z|.]+\-*[A-Za-z|.]+\-*[A-Za-z|.]+\.txt", str(arguments))
    filename = filename[0]
